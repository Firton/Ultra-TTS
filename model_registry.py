...
MODEL_DETAILS = {
    "piper": {
        "role": "軽量TTS",
        "summary": "ONNX音声を使う軽量なローカルTTSです。長文教材や一括生成に向いています。",
        "languages": ["English", "German", "French", "Spanish", "Chinese"],
        "strengths": ["高速", "CPU向き", "長文向き", "声追加が軽い"],
        "recommendedFor": ["教材読み上げ", "大量生成", "軽量なローカル実行"],
    ...
    "chatterbox": {
        "role": "多言語TTS",
        "summary": "日本語・英語を含む多言語生成に使えるバックエンドです。参照音声で声質を寄せる用途にも使えます。",
        "languages": [
            "Arabic",
            "Danish",
            "German",
    ...
    "mlx-chatterbox": {
        "role": "MLX多言語TTS",
        "summary": "Apple Silicon向けMLX版Chatterbox。日本語・英語・参照音声のワークフローに使えます。",
        "languages": ["Japanese", "English", "Chinese", "Korean", "French", "German", "Spanish", "Italian", "Portuguese", "Russian", "Arabic"],
        "strengths": ["Apple Silicon向き", "日本語", "英語", "voice cloning", "約2.6GB"],
    ...
    "mlx-qwen3-tts": {
        ...
        "strengths": ["Apple Silicon向き", "TTS LLM", "プリセット声", "voice cloning"],
    ...
    "mlx-qwen3-custom": {
        ...
        "languages": ["Japanese", "English", "Chinese", "Korean", "German", "French", "Russian", "Portuguese", "Spanish", "Italian"],
        "strengths": ["Apple Silicon向き", "TTS LLM", "感情指示", "スタイル指示", "複数プリセット声"],
    ...
    "mlx-qwen3-voice-design": {
        ...
        "languages": ["Japanese", "English", "Chinese", "Korean", "German", "French", "Russian", "Portuguese", "Spanish", "Italian"],
        "strengths": ["Apple Silicon向き", "声質設計", "感情/韻律指示", "TTS LLM"],
    ...
    "mlx-dia": {
        ...
        "languages": ["English"],
        "strengths": ["Apple Silicon向き", "2話者会話", "英語ダイアログ"],
